...
/// function firfilter INT
signed long long firfilter_int(int16_t val) {
static int pointer;
static int init=1;
...
/// function firfilter FLOAT
float firfilter_float(int16_t val) {
static int pointer;
static int init=1;
...
int demodulate_int (int16_t audioin) {
...
filterret=firfilter_int(audioin);
...
int demodulate_float (int16_t audioin) {
...
filterret=firfilter_float(audioin);
