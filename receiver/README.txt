***************************************************
** GMSK receiver + D-STAR extracter tool:
                   demonstration code and educational toolkit
...
receiver. If used on a computer or developement board that is attached
to a normal FM transceiver via its "9K6 packet" port, it
will receive GMSK and D-STAR packets and store them on disk or pass
...
It can also be used as a receiver for network-protocols that go beyond
the basic D-STAR specification:
...
Some of these boards (like friendlyarm mini2440) do have limited resources
...
See the document "PROGRAMMINGIT.txt" for more information.
