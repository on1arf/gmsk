...
snd_pcm_uframes_t buffersize=19200;
unsigned int val;
int dir;
int warning=0;


fprintf(stderr,"OPEN ALSA PLAYBACK \n");
...
snd_pcm_hw_params_set_buffer_size_near (s_global.alsahandle, params, &buffersize);
...
// all done, mark alsa as ready
s_global.alsaready=1;
...
fprintf(stderr,"OPENING ALSA CAPTURE! \n");
