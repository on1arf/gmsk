...
#define ALSACAPTURENONBLOCK 1 // 0=blocked alsa capture, 1 = NONblocked alsa read

#define ALSAPLAYBACKNONBLOCK 1 // 0=blocked alsa playback, 1 = NONblocked alsa read
