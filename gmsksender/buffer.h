...
int bufferfill_audio (int16_t * in, int size, int repeat, globaldatastr * pglobal) {
...
int bufferfill_bits (unsigned char * in, int invertin, int size, globaldatastr * pglobal) {
...
void bufferwaitdone_bits(globaldatastr * pglobal) {
int l=0;
...
void bufferwaitdone_audio(globaldatastr * pglobal) {
